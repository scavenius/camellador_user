...
List<LanguageDataModel> languageList() {
  return [
    LanguageDataModel(id: 1, name: 'Spanish', languageCode: 'es', fullLanguageCode: 'es-CO', flag: 'assets/flag/ic_co.png'),
    ...
    LanguageDataModel(id: 4, name: 'German', languageCode: 'de', fullLanguageCode: 'de-DE', flag: 'assets/flag/ic_de.png'),
  ];
}
...
Future<FirebaseRemoteConfig> setupFirebaseRemoteConfig() async {
  ...
  if (remoteConfig.getString(USER_CHANGE_LOG).validate().isNotEmpty) {
    ...
    await setValue(IN_MAINTENANCE_MODE, remoteConfigDataModel.inMaintenanceMode.validate());
