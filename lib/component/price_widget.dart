        ...
        Row(
          children: [
            if (isFreeService)
              ...
              Text(
                "${isCurrencyPositionLeft ? appConfigurationStore.currencySymbol : ''}${price.validate().toStringAsFixed(decimalPoint ?? appConfigurationStore.priceDecimalPoint).formatNumberWithComma()}${isCurrencyPositionRight ? appConfigurationStore.currencySymbol : ''}",
                style: _textStyle(),
              ),
            if (isHourlyService)
              Text(
