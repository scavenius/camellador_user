                  ...
                  Text.rich(
                    TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text:
                              "${isCurrencyPositionLeft ? appConfigurationStore.currencySymbol : ''}${calculateCouponDiscount(couponData: data, price: servicePrice.validate()).toStringAsFixed(appConfigurationStore.priceDecimalPoint).formatNumberWithComma()}${isCurrencyPositionRight ? appConfigurationStore.currencySymbol : ''}",
